...
public class VelocityUtils
{
     ...
     * @return 模板列表
     */
    public static List<String> getTemplateList(String tplCategory,int useMyBatisPlus)
    {
        List<String> templates = new ArrayList<String>();
        if(useMyBatisPlus == 1) {
            templates.add("vm/mybatisplus/domain.java.vm");
            templates.add("vm/mybatisplus/mapper.java.vm");
            templates.add("vm/mybatisplus/service.java.vm");
            templates.add("vm/mybatisplus/serviceImpl.java.vm");
            templates.add("vm/mybatisplus/controller.java.vm");
            templates.add("vm/mybatisplus/mapper.xml.vm");
        }else{
